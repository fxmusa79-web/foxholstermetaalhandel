  ...
  build: {
    rollupOptions: {
      input: {
        ...
        koper: 'pages/materialen/koper/index.html',
        kabels: 'pages/materialen/kabels/index.html',
        ferro: 'pages/materialen/ferro/index.html',
        grondkabels: 'pages/materialen/grondkabels/index.html',
